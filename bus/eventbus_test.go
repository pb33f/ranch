...
func (cl *MockRawConnListener) GetConnectionOpenChannel() chan *stompserver.Connection {
    return nil
}

func (cl *MockRawConnListener) GetConnectionCloseChannel() chan *stompserver.Connection {
    return nil
}
